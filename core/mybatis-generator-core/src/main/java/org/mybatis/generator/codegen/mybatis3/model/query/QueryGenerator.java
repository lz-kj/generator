 ...
 */
package org.mybatis.generator.codegen.mybatis3.model.query;
...
public class QueryGenerator extends AbstractJavaGenerator {
    ...
    public QueryGenerator(String project) {
        super(project);
    }
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        TopLevelClass topLevelClass = new TopLevelClass(type+"Query");
