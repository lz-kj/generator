 ...
 */
package org.mybatis.generator.codegen.mybatis3.model.vo;
...
public class VoGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        FullyQualifiedJavaType type = new FullyQualifiedJavaType(
                introspectedTable.getVoRecordType());
        TopLevelClass topLevelClass = new TopLevelClass(type+"Vo");
    ...
    public String getRootClass() {
        ...
        if (rootClass == null) {
            Properties properties = context
                    .getJavaVoGeneratorConfiguration().getProperties();
